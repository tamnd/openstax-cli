...
Most of these come down to network reality or how openstax serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openstax rate-limits like any public site. openstax already paces
...
Where a surface is gated, openstax reads a cookie or token you supply
...
`openstax`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openstax actually did
